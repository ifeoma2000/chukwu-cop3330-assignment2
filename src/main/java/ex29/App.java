...
public class App {
    public static void main(String[] args)
    {
       ...
       while(r.equals("0") || !r.matches("-?\\d+(\\.\\d+)?"))
       {
           System.out.println("Sorry. That's not a valid input.");
           System.out.print("What is the rate of return?");
           r = input.nextLine();
       }
        System.out.printf("It will take %d years to double your initial investment.", (int)quickCalculator(Integer.parseInt(r)));
    }
    public static double quickCalculator(double rate)
    {
